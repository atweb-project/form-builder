...
import { FormDropContainerComponent } from './form-builder/form-drop-container/form-drop-container.component';
import { FormDroppableContainerComponent } from './form-builder/form-droppable-container/form-droppable-container.component';

@NgModule({
  declarations: [HomeComponent, DashboardComponent, FormBuilderComponent, LayoutTabComponent, FormComponentsTabComponent, FormSettingsTabComponent, FormDropContainerComponent, FormDroppableContainerComponent],
